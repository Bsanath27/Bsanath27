...
def generate_samples():
    ...
    output_dir = os.path.join(root_path, "15epoch-samples")
    ...
    print(f"Loading 15-epoch weights from {gpt_checkpoint}...")
    saved_sd = torch.load(gpt_checkpoint, map_location="cpu")
    
    # Try to map keys if there's a mismatch
    # Common mapping: gpt.h -> gpt_inference.transformer.h
